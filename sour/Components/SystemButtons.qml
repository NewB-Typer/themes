// Modified by Milan Gurung https://github.com/newB-Typer
...
states: [
    State {
        name: "pressed"
        when: parent.children[index] && parent.children[index].down
        PropertyChanges {
        ...
        PropertyChanges {
            target: parent.children[index]
            background: parent.children[index].background ? parent.children[index].background : null
            border.color: Qt.darker(root.palette.highlight, 1.1)
        }
    },
    State {
        name: "hovered"
        when: parent.children[index] && parent.children[index].hovered
        PropertyChanges {
            target: parent.children[index]
    ...
    State {
        name: "focused"
        when: parent.children[index] && parent.children[index].activeFocus
        PropertyChanges {
            target: parent.children[index]

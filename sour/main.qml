...
Pane {
    ...
    Item {
        ...
        Rectangle {
            ...
            z: 1
            border.width: config.FormBorderWidth
            border.color: config.FormBorderColor
        }
...
fillMode: config.ScaleImageCropped == "crop" ? Image.PreserveAspectCrop
        : config.ScaleImageCropped == "fit" ? Image.PreserveAspectFit
        : Image.Stretch
            asynchronous: true
            cache: true
            clip: true
